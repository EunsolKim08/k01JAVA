...
class MultiAdderThread2 extends Thread{
	SumMulit2 sumInst; //멤버변수를 composition관계로 가짐. 위의 공유객체를 멤버변수로 선언
	int start, end;
	public MultiAdderThread2(SumMulit2 sumInst, int start, int end) {
...
public class Ex05Sync2Mehtod {

	public static void main(String[] args) {
		//공유객체로 사용할 객체 생성(하나만 생성)
		SumMulit2 s= new SumMulit2();
