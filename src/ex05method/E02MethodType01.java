...
/*
 Method(메서드, 함수)
 : 객체지향 프로그램에서 행동 또는 동작을 의마한다.
 즉 어떤 하나의 업무를 처리한 모듈이라 정의할 수 있다.
...
- 메서드 or 변수: simepleFunc => 소문자로 시작하는 Camel case
- 상수: SIMPLE_FUNC => 전체를 대문자로, 연결단어는 _(언더바)로 표현
- 패키지: simple.func =>전체를 소문자로, 연결단어는 .(점)으로 표현
*/
...
/*
 필요에 따라 실행부가 없는 메서드를 정의하는 경우가 있따.
 */
