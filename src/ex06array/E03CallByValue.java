...
/*
 Call by value(값에 의한 호출)
 	...
 	메모메리적 관점에서 보면 스택영역만 사용하는 케이스로 main과 호출된
 	메소드는 서로 다른 지역이므로 서로에게 영향을 미치지 않는것이
 	특징이다.
 */
public class E03CallByValue
{
	...
	static void callByValue(int fNum, int sNum)
	{
		...
		fNum = sNum;
		sNum = temp;
		System.out.println("[callByBalue 메소드안]" +
