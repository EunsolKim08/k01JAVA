...
public class E01OneDimArray02
{
	...
	public static void main(String[] args)
	{
		...
		/*난수생성방법2
		  : Random클래스를 사용한다. 사용방법은 Scanner와 동일하게
		...
		/*
		 ...
		 1.0xxx형태의 난수를 생성한 후 정수로 변경하기 위해 100을
		 	곱한 후 정수로 변환한다.(소수 이하 절사)
		 2. 45로 %연산하여 나머지를 구한다. 모든 정수는 45로 나누었을
		 	때 나머지가 0~44로 나오게된다.
		 3. 0은 구간에 포함되지 않으므로 2번의 결과에 1을 더한다.
		 	결과적으로 1 ~45사이의 낸수를 생성할 수 있다.
		 */
