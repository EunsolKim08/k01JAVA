...
public class E01If01 {
	...
	public static void main(String[] args) throws IOException {
		...
		/*
		아래 문장은 조건식이 아닌 산술식이므로 에러가 밸생된다.
		if(num%2) {
		...
		*/
		...
		//경우에 따라 무조건 샐항되는 if문도 필요하다.
		if(true) {
			System.out.println("무조건 실행되는 if문입니다.");
		}
		if(num%2 !=0);
		// 조건식에 상괎이 다음 문장이 실행되는 형태로 세미콜론은 문장의끝을 나타내므로 사용에 주의해야 한다.
		{
			 System.out.printf("%d는 홀수입니다", num);
		}
		/*조건 검사 후 실행할 문장이 1개인 경우에는 중괄호를 생략할 수 있다.
		 단 실행문이 2개 이상인 경우에는 한 문장만 실행되므로 반드시 중괄호를 작성해야 한다.
