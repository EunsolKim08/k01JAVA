...
class MyClass{
	...
	/*
	 MyClass 형의 객체의 비교를 위해 오버라이딩한 메서드.
	...
	public boolean equals(Object obj) {
		/*
		 ...
		 먼저 판단한다. instanceof 연산자는 해당객체와 상속관계가 있는지를
		 판단한다.
		 */
...
public class E04Object3Equals {
	...
	public static void main(String[] args) {
		...
		System.out.println("mc1.toString(0=> "+mc1.toString());
		System.out.println("mc2.toString(0=> "+mc2.toString());
