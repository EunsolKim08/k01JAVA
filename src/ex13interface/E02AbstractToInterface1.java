...
/*
 ...
 -객게 생성은 할 수 없으나 그외 참조변수, 상속 등의 모든 기능을 할 수 있다.
 
 추상메서드
 -오버라이딩의 목적으로 제작된다.
 -메서드의 실행부가 없기 때문에 중괄호{}대신에 ;를 붙여준다.
 */
...
class PersonInfoDTO{
	...
	/*
	 getter/setter 메서드: DTO객체에서 private으로 선언된 멤버 변수의
	 값을 설정하거나 반환할 때 호출하는 메서드.
	 */
	public PersonInfoDTO(String name, String juminum) {
		super();
		this.name = name;
