...
class AbsClassChild1 extends AbsClass1{
	...
	/*
	 ...
	 강제사항이 아닌 선택사항이다. 즉 필요한 경우에만 오버라이딩한다.
	 */
	void instanceMethod() {
		System.out.println("필요없다면 오버라딩 하지 않아도 상관없다.");
	}
}
/*
...
/*
 ...
 해당 클래스도 abstract로 선언해야 한다. 단, 이 경우 해당클래스로도
 재정의
 */
class AbsClassChild2 extends AbsClass2{
	void absMethod(int number) {
		System.out.println("부모클래스에서 오버라이딩한 메소드로"
				+ "없을 땐 에러발생함.");
	}
	void newMethod() {
...
public class E01AbstractBasic{
	...
	public static void main(String[] args) {
		...
		/*
		  추상클래스에 선언된 정적멤버메서드는 오버라이딩의 대상이
		 아니므로 static의 기본규칙을 따른다. 즉, 클래스명으로 
		 접근하면 된다.		 
		 */
